...
Route::get('/', function () {
    ...
    \App\Facades\Telegram::buttons(5431617179, 'test', \App\Telegram\Helpers\KeyboardButton::$buttons)->send();
    //dd(\App\Facades\Telegram::payment(5431617179, 'Тестовая оплата', 'Описание товара', ['transaction_id' => 1], [['label' => 'Айфон 14 ', 'amount' => 12000]])->send());
